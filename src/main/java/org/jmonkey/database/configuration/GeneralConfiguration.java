...
public class GeneralConfiguration extends DatabaseSavedConfiguration {
    ...
    public String getUserAgent() { return (this.userAgent == null) ? "JMonkey Resource Website" : this.userAgent; }
    public void setUserAgent(String userAgent) { this.userAgent = userAgent; }

    @Column(name = "general_page_title_prepend", length = 128)
    public String getPageTitlePrepend() { return (this.pageTitlePrepend == null) ? "" : this.pageTitlePrepend; }
    ...
    public String getPageTitleAppend() { return (this.pageTitleAppend == null) ? "" : this.pageTitleAppend; }
